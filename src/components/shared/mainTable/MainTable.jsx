...
function MainTable() {
  ...
  return (
    <div
      className={` ${mainDivCss} p-4 bg-[#fff] rounded-sm border-[1px] border-slate-200 transition-all`}
    >
        ...
        <div className="flex gap-2">
          ...
          <ZoomButton
            onclick={() => {
              mainDivCss === ""
                ? setMainDivCss(
                    "absolute top-0 bottom-0 w-[96.5vw] left-0 z-50 m-8"
                  )
                : setMainDivCss("");
      ...
      <div
        className={`flex flex-col overflow-y-auto overflow-x-auto  ${tableDivCss} ${
              ...
              {table.getHeaderGroups().map((headerGroup) => (
                ...
                >
                  {headerGroup.headers.map((header) => (
                    ...
                    >
                      <div className="flex items-center gap-1 select-none w-max">
