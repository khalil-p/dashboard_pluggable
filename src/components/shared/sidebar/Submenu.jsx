...
const linkClases =
  "flex items-center gap-2 font-medium pl-5 py-2 mt-[0.125rem] mb-[0.125rem] hover:bg-neutral-700 hover:text-white hover:no-underline active:bg-netral-600 rounded-sm text-base";
